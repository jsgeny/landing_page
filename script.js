...
window.addEventListener("scroll", function() {
        ...
        if (document.querySelector('.flex_width_content_one').clientWidth < 835  && 235 >= window.pageYOffset) {
            buttonTopWrapper.style.display = 'none';
        } else if (document.querySelector('.flex_width_content_one').clientWidth < 835 &&  window.pageYOffset >= 533 && (document.body.getBoundingClientRect()).top > scrollPos) {
